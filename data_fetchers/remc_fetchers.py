...
def fetchFcaDayAheadDf():
    ...
    if not(os.path.exists(fPath)):
        fPath = r'input_data\fca\DAY_AHED_{0}.csv'.format(getDateStr(0))
...
def fetchFcaForeVsActDf():
    ...
    if not(os.path.exists(fPath)):
        fPath = r'input_data\fca\FC_VS_AC_{0}.csv'.format(getDateStr(0))
...
def fetchFcaForeVsActPrevDf():
    ...
    if not(os.path.exists(fPath)):
        fPath = r'input_data\fca\FC_VS_AC_{0}.csv'.format(getDateStr(-1))
...
def fetchIftDayAheadDf():
    ...
    if not(os.path.exists(fPath)):
        fPath = r'input_data\ift\DAY_AHED_{0}.csv'.format(getDateStr(0))
...
def fetchIftForeVsActDf():
    ...
    if not(os.path.exists(fPath)):
        fPath = r'input_data\ift\FC_VS_AC_{0}.csv'.format(getDateStr(0))
    iftForeVsActDf = pd.read_csv(fPath)
...
def fetchResDayAheadDf():
    ...
    if not(os.path.exists(fPath)):
        fPath = r'input_data\res\DAY_AHED_{0}.csv'.format(getDateStr(0))
...
def fetchResForeVsActDf():
    ...
    if not(os.path.exists(fPath)):
        fPath = r'input_data\res\FC_VS_AC_{0}.csv'.format(getDateStr(0))
    resForeVsActDf = pd.read_csv(fPath)
...
def fetchAleaDayAheadDf():
    ...
    if not(os.path.exists(fPath)):
        fPath = r'input_data\aleasoft\DAY_AHED_{0}.csv'.format(getDateStr(0))
...
def fetchAleaForeVsActDf():
    ...
    if not(os.path.exists(fPath)):
        fPath = r'input_data\aleasoft\FC_VS_AC_{0}.csv'.format(getDateStr(0))
...
def fetchEnerDayAheadDf():
    ...
    if not(os.path.exists(fPath)):
        fPath = r'input_data\enercast\DAY_AHED_{0}.csv'.format(getDateStr(0))
...
def fetchEnerForeVsActDf():
    ...
    if not(os.path.exists(fPath)):
        fPath = r'input_data\enercast\FC_VS_AC_{0}.csv'.format(getDateStr(0))
